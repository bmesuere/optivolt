...
export function getElements() {
  return {
    ...
    evScheduleEntriesCount: $("#ev-schedule-entries-count"),
    evEntryAdd: $("#ev-entry-add"),
    evEntryEditor: $("#ev-entry-editor"),
    evEntryTimeLabel: $("#ev-entry-time-label"),
    evEntryTime: $("#ev-entry-time"),
    evEntryTimeClear: $("#ev-entry-time-clear"),
    evEntryTimeNow: $("#ev-entry-time-now"),
    evEntryTimeHorizon: $("#ev-entry-time-horizon"),
    evEntryEndRow: $("#ev-entry-end-row"),
    evEntryEndTime: $("#ev-entry-end-time"),
    evEntryEndClear: $("#ev-entry-end-clear"),
    ...
    evEntryDelete: $("#ev-entry-delete"),
    evEntryCancel: $("#ev-entry-cancel"),
